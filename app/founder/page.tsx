          ...
          <div className="bg-background/50 rounded-xl p-8 shadow-inner">
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-lg leading-relaxed">
                ...
                <p>सही आधार, मजबूत शब्दावली और स्मार्ट अभ्यास के साथ, बिहार और झारखंड के छात्र आत्मविश्वास और स्पष्टता के साथ धाराप्रवाह अंग्रेज़ी बोल सकते हैं।</p>
                <p>5Vowels में, श्री कुमार के मार्गदर्शन में, हम केवल अंग्रेज़ी नहीं सिखा रहे — हम आत्मविश्वास पैदा कर रहे हैं, सोचने का दृष्टिकोण बदल रहे हैं, और छात्रों को एक वैश्विक भविष्य के लिए तैयार कर रहे हैं।</p>
              </div>
            </div>
          </div>
        </div>
